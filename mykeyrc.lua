...
globalkeys = awful.util.table.join(
   ...
   awful.key({  modkey}, "s", function () toggle_tag_with_shifty(" " ,"Erlang",{class="Erlang"}) end),
...
--   awful.key({modkey}, "F3", function () awful.util.spawn("urxvtc -name toggled_urxvt" ) end),
   ...
   awful.key({       }, "F1", function () drop_only("urxvtc -name f1",true ,"center","center",900,600,false,1) end),
   ...
   -- awful.key({       }, "F4", function () drop_only("urxvtc -name f44",true,"center","center",900,600,false,1) end),
   awful.key({modkey }, "F4", function () drop_only("urxvtc -name f4",true ,"center","center",900,600,false,1) end),
   awful.key({modkey }, "F1", function () drop_only("sudo urxvtc -name f1_root",true ,"center","center",900,600,false,1) end),
...
---   awful.key({modkey}, "F4", function () awful.util.spawn("sudo urxvtc -name toggled_urxvt_root" ) end),
   -- awful.key({      }, "F12", function () drop_only("urxvtc -e sh -c \" tail -f /home/jixiuf/lszm2/server/game_server/log/*\"", false, "bottom","center",1280,780,false,1)end),
   awful.key({      }, "F12", function () drop_only("urxvtc -e sh -c \" sudo  tail -f /var/log/messages /var/log/emerge-fetch.log /tmp/emerge.log\"", false, "bottom","center",1280,780,false,1)end),
...
--   awful.key({ modkey       }, "f",  function () run_or_raise_by_uuid("firefox") end),
   ...
   awful.key({modkey,       }, "x",  function ()  toggle_tag_with_shifty(" VirtualBox --comment x --startvm c55b46ca-cae3-4314-a051-2b201e7e79c7 --no-startvm-errormsgbox" ,"vbox",{class="VirtualBox"}) end),
