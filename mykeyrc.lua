...
---   awful.key({modkey}, "F4", function () awful.util.spawn("sudo urxvtc -name toggled_urxvt_root" ) end),
   ...
   awful.key({      }, "F12", function () drop_only("urxvtc -e sh -c\" sudo  tail -f /var/log/messages\"", false, "bottom","center",1280,780,false,1)end),
...
--   awful.key({ modkey       }, "f",  function () run_or_raise_by_uuid("firefox") end),
   ...
   awful.key({modkey,       }, "x",  function ()  toggle_tag_with_shifty(" VirtualBox --comment x --startvm 6af3086d-8a25-43dd-a6ef-9691cebac0bf --no-startvm-errormsgbox" ,"vbox",{class="VirtualBox"}) end),
